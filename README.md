...
Telemetry flow:
1. Client calls the Web App (`/health`, `/crash`)
2. FastAPI handles the request
3. OpenTelemetry instrumentation records request telemetry
4. Telemetry is exported to Application Insights via `APPLICATIONINSIGHTS_CONNECTION_STRING`
